...
APPLE_TARGET="qrcode-cli-${VERSION}-osx.tgz"
APPLE_TARGET_SIG=${APPLE_TARGET}.sig
APPLE_RELEASE="target/${APPLE_TARGET}"
APPLE_RELEASE_SIG=${APPLE_RELEASE}.sig
tar zcvf ${APPLE_RELEASE} target/x86_64-apple-darwin/release/qrcode-cli
...
LINUX_TARGET="qrcode-cli-${VERSION}-linux-amd64.tgz"
LINUX_TARGET_SIG=${LINUX_TARGET}.sig
LINUX_RELEASE="target/${LINUX_TARGET}"
LINUX_RELEASE_SIG=${LINUX_RELEASE}.sig
tar zcvf ${LINUX_RELEASE} target/x86_64-unknown-linux-musl/release/qrcode-cli
